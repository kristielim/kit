    ...
    team && (
      ...
      >
        <View style={styles.topBar}>
          <Image style={styles.teamIcon} source={getIcon(team)} />
        </View>
        <View style={styles.midBar}>
          <View style={styles.midBarSub}>
            <View style={styles.row}>
              <KitText size={18} color={"#848383"}>
                49
              </KitText>
              <Image source={Awws} />
            </View>
          ...
          <View style={styles.midBarSub}>
            ...
            <View>
              <KitText size={14} color={Colors.KIT_DARKEST_BLACK}>
                challenges
              </KitText>
              <KitText size={14} color={Colors.KIT_DARKEST_BLACK}>
                completed
        ...
        <View style={styles.botBar}>
          <View style={[styles.superlatives, { paddingTop: 15 }]}>
            ...
            <KitText size={10} color={Colors.KIT_DARKEST_BLACK}>
              ◆ most wooed ◆
            </KitText>
          </View>
        ...
        <ScrollView contentContainerStyle={styles.pastChallengeWrapper}>
          <KitText style={{ alignSelf: "flex-start" }} size={18}>
            Past Challenges
          </KitText>

          <View style={styles.pastChallengeCardWrapper}>
            <KitText
              style={styles.pastChallengeDate}
            ...
            <View style={styles.pastChallengeCard}>
              <View style={styles.pastChallengeText}>
                ...
                <KitText color={Colors.KIT_WHITE}>
                  Let out your inner DaVince and make a portrait of your ...more
                </KitText>
              </View>
